...
Für die Gründung deines Unternehmens ist in jedem Fall ein <Hide showIf={props.legalForm == "ug"}> UG </Hide><Hide showIf={props.legalForm == "gmbh"}> GmbH </Hide>-Gesellschaftsvertrag nötig. Diesen Vertrag nennt man auch gerne Satzung. In diesem Vertrag sind alle wichtigen Eckdaten für deine Firma festgeschrieben.
...
<Hide showIf={props.legalForm == "ug"}> 
1 Gesellschafter:
...
<Hide showIf={props.legalForm == "gmbh"}> 
1 Gesellschafter:
