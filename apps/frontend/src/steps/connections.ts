...
export const taskGraph: ConnectionsData = {
	...
	nodes: {
		...
		"323_mit_Berufsgenossenschaft": {
			...
			shortName: "Berufsgenossenschaft über Steuerberater",
		...
		"324_mit_Lohnrechnungen_abgeben": {
			...
			shortName: "Lohnrechnungen über Steuerberater",
