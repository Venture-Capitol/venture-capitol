...
Manchmal brauchst du einen individuellen Gesellschaftsvertrag für deine <Hide showIf={props.legalForm == "ug"}> UG </Hide><Hide showIf={props.legalForm == "gmbh"}> GmbH </Hide>.
...
Der Unternehmensgegenstand beschreibt die Art der Betätigung einer Gesellschaft, bzw. den Bereich in dem ihr vor habt tätig zu sein. Er darf interessanterweise sowohl gewerblich als auch ideell sein. Der Unternehmensgegenstand ist zwingenden Inhalt der Satzung der <Hide showIf={props.legalForm == "ug"}> UG </Hide><Hide showIf={props.legalForm == "gmbh"}> GmbH </Hide> und wird später im Prozess auch in das Handelsregister eingetragen

Ziel ist dass der Schwerpunkt der Geschäftstätigkeit der Gesellschaft deutlich erkennbar wird. Man sollte mit dem Unternehmensgegenstand sofort erkennen können, in welcher Art und in welchem unternehmerischen Geschäftszweig eine <Hide showIf={props.legalForm == "ug"}> UG </Hide><Hide showIf={props.legalForm == "gmbh"}> GmbH </Hide> tätig ist.
