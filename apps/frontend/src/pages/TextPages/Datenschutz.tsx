		...
		>
			...
			>
				<TextBlock title='Datenschutzerklärung' arrow={true}>
					...
					<TextAbsatz title='2. Verantwortlich für diese Website'>
					...
					<TextAbsatz title='3. Wozu diese Texte?'>
					...
					<TextAbsatz title='4. Ganz wichtig für Sie!'>
						...
						Sicherheitslücken aufweisen kann. Internetbasierte
						Datenübertragungen können ganz grundsätzlich Sicherheitslücken
						aufweisen, sodass ein absoluter Schutz nicht gewährleistet werden
						kann. Das solltest du immer im Kopf haben, auf jeder Seite im
						Internet.
						<br />
						<br />
					...
					<TextAbsatz title='5. Welche Rechte du an deinen Daten hast'>
					...
					<TextAbsatz title='6. Wir betreiben viele Websites'>
					...
					<TextAbsatz title='7. Begriffserklärungen'>
					...
					<TextAbsatz title='8. Rechtsgrundlage der Verarbeitung'>
						Wir beziehen uns auf Art. 6 Abs. 1 lit. b DSGVO.
						<br />
						<br />
						Wenn wir personenbezogene Daten von dir brauchen, um einen Auftrag
						zu erfüllen, fragen wir explizit nach deiner Erlaubnis.
						<br />
						<br />
						In Art. 6 DSGVO steht ganz am Anfang: „Die Verarbeitung ist nur
						rechtmäßig, wenn mindestens eine der nachstehenden Bedingungen
						erfüllt ist: Die betroffene Person hat ihre Einwilligung zu der
						Verarbeitung der sie betreffenden personenbezogenen Daten für einen
						oder mehrere bestimmte Zwecke gegeben.“ Darauf beziehen wir uns in
						diesem Fall.
						<br />
						<br />
						...
						einer Lieferung von einem schriftlichen Produkt oder Vertrag per
						Post, oder einer Anfrage oder beispielsweise zur Erfüllung
						steuerlicher Pflichten. Wenn das Erfordernis der Fall ist, beruht
					...
					<TextAbsatz title='9. Unser Hosting'>
					...
					<TextAbsatz title='10. Technik'>
						...
						übermittelst, dann erhalten wir wirklich nur solche Daten, die dein
						Browser an unseren Server übermittelt. Diese Information nennt man
					...
					<TextAbsatz title='11. Weitergabe von Daten an Dritte'>
					...
					<TextAbsatz title='13. Content Delivery Network'>
					...
					<TextAbsatz title='14. Kontaktformular'>
