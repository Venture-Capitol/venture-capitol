		...
		>
			...
			>
				<TextBlock title='Impressum' arrow={true}>
					<TextAbsatz title='Betreiber dieser Website'>
					...
					<TextAbsatz title='Geschäftsführer'>Luis Rieke</TextAbsatz>

					<TextAbsatz title='USt-ID'>USt-ID: DE317616086.</TextAbsatz>

					<TextAbsatz title='Inhaltlich Verantwortlicher'>
						gemäß § 55 Abs. 2 RStV
						<br />
						Luis Rieke (Anschrift wie oben)
					</TextAbsatz>

					<TextAbsatz title='Datenschutzbeauftragter'>
						Luis Rieke
						<br />
						<br />
						Telefon: <a href='tel:+493089636852'>+49 (0) 30 896 368 52</a>
					...
					<TextAbsatz title='Schutz deiner Daten'>
						Siehe dazu unsere{" "}
						<a href='/textpages/datenschutz'>Datenschutzerklärung.</a>
					</TextAbsatz>

					<TextAbsatz title='Haftung für unsere Inhalte'>
					...
					<TextAbsatz title='Haftungshinweis bei externen Links'>
					...
					<TextAbsatz title='Unser Urheberrecht und dein Urheberrecht sind uns wichtig'>
					...
					<TextAbsatz title='Verstöße, Kritik und Verbesserungsvorschläge'>
