		...
		<div className='content'>
			<TextBlock title='Impressum' arrow={true}>
				...
				<TextParagraph title='Haftung für unsere Inhalte'>
					...
					§ 18 Abs. 2 Medienstaatsvertrag für eigene Inhalte auf diesen Seiten
					nach den allgemeinen Gesetzen verantwortlich.
					<br />
					<br />
					Weiße uns also bitte freundlich darauf hin, wenn es Inhalte gibt, die
					inhaltlich korrigiert werden müssen. Wir werden dem nachkommen.
				</TextParagraph>
				...
				<TextParagraph title='Haftungshinweis bei externen Links'>
					...
					jeweilige Anbieter oder Betreiber der Seiten verantwortlich und nicht
					wir. Die verlinkten Seiten wurden zum Zeitpunkt der Verlinkung auf
					...
					Rechtsverletzungen werden wir derartige Links natürlich umgehend
					entfernen.
				</TextParagraph>
				...
				<TextParagraph title='Verstöße, Kritik und Verbesserungsvorschläge'>
					...
					Kritik äußern willst, möchten wir dich bitten zunächst mit uns Kontakt
					aufzunehmen. Über alles lässt sich reden und wir finden bestimmt eine
					Lösung auch ohne Anwalt.
					<br />
					<br />
					Über Vorschläge und Ideen freuen wir uns sowieso, also keine Scheu vor
					der Kontaktaufnahme.
					<br />
					<br />
					<a href='mailto:luis.rieke@spacifik.com'>luis.rieke@spacifik.com</a>
