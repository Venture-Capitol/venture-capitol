		...
		<div>
			<TextBlock title='Datenschutz&shy;erklärung' arrow={true}>
				<TextParagraph title='Einleitung'>
					...
					oft wissen wir nicht wirklich, was im Hintergrund geschieht. Deswegen
					legt diese Seite die Karten auf den Tisch und zeigt, was Sache ist.
					Wir versuchen dir hier transparent zu erklären, wie diese Website
					arbeitet und wenn Fragen offen bleiben, komm gerne auf uns zurück.
				</TextParagraph>
				...
				<TextParagraph title='Verantwortlich für diese Website'>
					...
					<br />
					<br />
					Verantwortliche Person für die Website und Datenschutzbeauftragter:
					Luis Rieke
					<br />
				...
				<TextParagraph title='Wozu diese Texte?'>
					...
					Datenschutzgesetzen zu erklären.
					<br />
					<br />
					...
					genutzt werden kann. Du wirst also nicht verpflichtet dich auf dieser
					Seite anzumelden. Deine IP ist natürlich notwendig zur Verwendung des
					Internets und ist von den den Servern lesbar.
					<br />
					<br />
					Alle Daten werden immer im Einklang mit der Datenschutz
					Grundverordnung (DSGVO) und mit den für die „Spacifik UG
					(haftungsbeschränkt)“ geltenden landesspezifischen
					Datenschutzbestimmungen verarbeitet.
					<br />
					<br />
					Diese einzelnen Datenschutzerklärungen zeigen dir im folgenden genau,
					wie viele und welche Daten wir erheben und wieso.
				</TextParagraph>

				<TextParagraph title='Ganz wichtig für dich'>
					Von Anfang an haben wir darauf geachtet, dass deine Daten sicher sind
					und wir diese schützen. Wir arbeiten mit zahlreichen Maßnahmen, um
					einen möglichst lückenlosen Schutz der über diese Internetseite
					verarbeiteten personenbezogenen Daten sicherzustellen. Wir verzichten
					beispielsweise auf die Verwendung externer Cookies.
					<br />
					<br />
					Wir weisen jedoch darauf hin, dass die Datenübertragung im Internet
					Sicherheitslücken aufweisen kann. Internetbasierte Datenübertragungen
					können ganz grundsätzlich Sicherheitslücken aufweisen, sodass ein
					absoluter Schutz nicht gewährleistet werden kann. Das solltest du
					immer im Kopf haben, auf jeder Seite im Internet.
					<br />
					<br />
					Dies kann zum Beispiel durch Lücken beim WLAN Router der Fall sein.
					Eine anständige Firewall und ein geschützter Browser sind hierbei von
					Vorteil. Am sichersten unterwegs ist man vermutlich mit Linux
				...
				<TextParagraph title='Begriffserklärungen'>
					...
					<br />
					<br />
					Die hier aufgeführten Begrifflichkeiten wurden bei dem Erlass der
					Datenschutz Grundverordnung (DSGVO) verwendet.
					<br />
					<br />
				...
				<ol>
					<li>
						...
						oder eine andere Stelle, die personenbezogene Daten im Auftrag eines
					...
					<li>
						<b>Dritter</b> ist eine natürliche oder juristische Person, Behörde,
						Einrichtung oder andere Stelle. Aber auf jeden Fall jemand anders
						als du und wir. Er ist also jemand außer der betroffenen Person
						(also gegebenenfalls du), dem Verantwortlichen, dem
						...
						dazu berechtigt wurden, die personenbezogenen Daten zu verarbeiten.
					</li>
					<li>
						<b>Einschränkung der Verarbeitung</b> ist die Markierung der
						personenbezogenen Daten um die künftige Verarbeitung einzuschränken.
					</li>
					<li>
					...
					<li>
						...
						zur Verfügung gestellt werden. Behörden, die im Rahmen eines
						bestimmten Untersuchungsauftrags personenbezogene Daten einfordern,
						gelten jedoch nicht als Empfänger.
					</li>
					<li>
						<b>Personenbezogene Daten</b> sind alle Informationen, die sich auf
						dich als identifizierbare natürliche Person beziehen. Das kann so
						etwas sein wie beispielsweise dein Name, dein Standort oder
					...
					<li>
						...
						Daten um bestimmte persönliche Aspekte, die sich auf eine natürliche
						Person beziehen zu schätzen, zu analysieren und gegebenenfalls zu
						bewerten.
					</li>
					<li>
						<b>Pseudonymisierung</b> ist die Verarbeitung personenbezogener
						Daten, so dass nicht mehr eine spezifische Person zugeordnet werden
						kann. Es können also keine erfassten Daten einer identifizierbaren
				...
				<TextParagraph title='Rechtsgrundlage der Verarbeitung'>
					...
					<br />
					<br />
					Wenn wir personenbezogene Daten von dir brauchen, um einen Auftrag zu
					erfüllen, fragen wir explizit nach deiner Erlaubnis.
					<br />
					<br />
					In Art. 6 DSGVO steht ganz am Anfang: „Die Verarbeitung ist nur
					rechtmäßig, wenn mindestens eine der nachstehenden Bedingungen erfüllt
					ist: Die betroffene Person hat ihre Einwilligung zu der Verarbeitung
					der sie betreffenden personenbezogenen Daten für einen oder mehrere
					bestimmte Zwecke gegeben.“ Darauf beziehen wir uns in diesem Fall.
					<br />
					<br />
					Manchmal ist die Verarbeitung personenbezogener Daten zur Erfüllung
					eines Vertrags, wo du unser Vertragspartner bist, erforderlich. Das
					kann bei klassischen Verarbeitungsvorgängen sein, wie zum Beispiel
					einer Lieferung von einem schriftlichen Produkt oder Vertrag per Post,
					oder einer Anfrage oder beispielsweise zur Erfüllung steuerlicher
					Pflichten. Wenn das Erfordernis der Fall ist, beruht die Verarbeitung
					auf Art. 6 Abs. 1 lit. b DSGVO.
					<br />
					<br />
					Unwahrscheinlich ist, aber auch hierauf wollen wir eingehen, dass
					jemand in Gefahr ist. Wenn zum Beispiel ein Besucher sich in unserem
					Unternehmen schwer verletzt, geben wir natürlich lebenswichtige
					Informationen an einen Arzt, das Krankenhaus oder sonstige Dritte.
					Auch hier beruht die Verarbeitung auf Art. 6 Abs. 1 lit. d DSGVO. In
					seltenen Fällen kann also die Verarbeitung von personenbezogenen Daten
					erforderlich sein um lebenswichtige Interessen der betroffenen Person
					zu schützen.
				</TextParagraph>
				...
				<TextParagraph title='Unser Hosting'>
					...
					<br />
					<br />
					Außerdem hat Google ihre Nutzungsbedingungen im Lauf der Jahre auf der
					Grundlage des Feedbacks von Kunden und Aufsichtsbehörden angepasst und
					...
					Ihre Anfrage in der Regel in einem Land, in dem du mit deinem Endgerät
					suchst. Kritische Länder, Bots oder Crawls können so automatisiert
					geblockt werden um Angriffe auf die Seite und einen Upload von
					bösartigen Inhalten zu verhindern.
					<br />
					<br />
					...
					<br />
					<br />
					Auf den Systemen von Cloudflare werden automatisiert Protokolle (sog.
					Logfiles) für bestimmte Dienste auf dem Server erfasst.
				</TextParagraph>

				<TextParagraph title='Logfiles'>
					Wenn du nur auf dieser Website bist, um dich zu informieren, also dich
					nirgends registrierst und auch keinen Kommentar schreibst und auch
					kein Formular benutzt oder uns anders Informationen übermittelst, dann
					erhalten wir wirklich nur solche Daten, die dein Browser an unseren
					Server übermittelt. Diese Information nennt man ein sogenanntes
					Server-Logfile.
					<br />
					<br />
				...
				<ol>
					...
					<li>Die Internetseite über die du auf unsere Seite gekommen bist</li>
				...
				<p>
					...
					keine Rückschlüsse auf dich als Person. Diese Daten werden anonym
					ausgewertet. Wir brauchen diese Informationen, damit wir:
				</p>
				<ol>
					<li>
				...
				<TextParagraph>
					...
					mit allen anderen Daten zusammengerechnet für uns interessant und wir
					versuchen statistisch und ferner mit dem Ziel, den Datenschutz und die
					Datensicherheit in unserem Unternehmen zu erhöhen, Auswertungen zu
					machen.
					<br />
					<br />
					Damit versuchen wir am Ende ein perfektes Schutzniveau für unsere
					personenbezogenen Daten und deren Verarbeitung sicherzustellen.
					<br />
					<br />
					Die Rechtsgrundlage für die Datenverarbeitung ist Art. 6 Abs. 1 S. 1
					lit. f DSGVO. Unser berechtigtes Interesse folgt also aus oben
					aufgelisteten Zwecken zur Datenerhebung, weil wir nur so die Seiten
				...
				<TextParagraph title='Weitergabe von Daten an Dritte'>
					...
					<br />
					<br />
					Wir geben deine persönlichen Daten wirklich nur dann an Dritte weiter,
					wenn:
					<br />
				</TextParagraph>
				...
				<ol>
					...
					<li>
						...
						Annahme besteht, dass du ein überwiegendes schutzwürdiges Interesse
						an Nichtweitergabe deiner Daten hast.
					</li>
				</ol>
				...
				<TextParagraph title='Cookies'>
					...
					<br />
					<br />
					Wenn du das erste Mal diese Seite besuchst, bekommst du jedoch diesen
					kleinen Text mit dem Verweis auf die Datenschutzerklärung und die
					Rechtsbelehrung. Damit wir uns merken können dass du diesen Hinweis
					gelesen hast haben wir hier selbst ein kleines Cookie dass die
					Information speichert dass du hier einmal den Button geklickt hast.
					<br />
					<br />
					In einem Cookie werden Daten gespeichert, die von deinem Gerät
					abhängen, was allerdings nicht bedeutet, dass wir dadurch unmittelbar
					Kenntnis von deiner Identität erlangen.
					<br />
					<br />
					Was noch wichtig ist für dich zu wissen, die meisten Browser
					akzeptieren Cookies automatisch. Du kannst allerdings in deinem
					Browser auch einstellen, dass keine Cookies auf deinem Computer
					gespeichert werden sollen oder dass immer ein Hinweis angezeigt wird,
					bevor ein neuer Cookie angelegt wird. Einfache Anleitungen wie du das
					machst findest du überall im Internet.
				</TextParagraph>
				...
				<TextParagraph title='Google Login'>
					...
					Logo rechts oben ist die Einbindung dieses Services. Da hiermit Google
					fonts und das Google Logo eingebettet sind und wir diese Assets vom
					Google Server abrufen, kennt Google deine IP.
					<br />
					<br />
					Genauer Dienstanbieter für firebase ist das Unternehmen Google Ireland
					...
					dass deine Daten auch den europäischen Datenschutzstandards
					entsprechen, wenn sie in Drittländer überliefert und dort gespeichert
					werden.
					<br />
					<br />
					...
					und verwaltet werden. Siehe Beschluss:
					<br />
					<a
					...
					werden, findest du in der Privacy Policy auf
					<br />
					<a
				...
				<TextParagraph title='Sentry'>
					Wir nutzen bei Venture Capitol Sentry, um technische Fehler richtig zu
					managen. Anbieter dafür ist das amerikanische Unternehmen Sentry Inc.,
					San Francisco, 132 Hawthorne St, San Francisco, USA.
					<br />
					<br />
					...
					<br />
					<br />
					Die genauen Datenverarbeitungsbedingungen für Sentry (Data Processing
					Addendum), welche den Standardvertragsklauseln entsprechen, findest du
					unter:
					<br />
